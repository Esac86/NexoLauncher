...
* **GUI**: [CustomTkinter](https://github.com/TomSchimansky/CustomTkinter) (UI moderna y responsiva)
* **Motor**: `minecraft-launcher-lib` (Integración oficial con servicios de Mojang)
* **Imagen**: Pillow (PIL) para procesamiento gráfico optimizado.

---

## 🏗️ Requisitos para Auditoría
